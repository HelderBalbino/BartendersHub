...
const createCocktailValidation = [
  ...
  body('glassType')
    .notEmpty()
    .withMessage('Glass type is required')
];
...
router.post('/', protect, uploadLimiter, upload.single('image'), createCocktailValidation, handleValidationErrors, createCocktail);
router.put('/:id', protect, uploadLimiter, upload.single('image'), updateCocktail);
...
router.post('/:id/rating', protect, ratingValidation, handleValidationErrors, rateCocktail);
