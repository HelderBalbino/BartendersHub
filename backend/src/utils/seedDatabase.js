...
const cocktails = [
  {
    ...
    description: 'The quintessential gin cocktail, crisp and clean with a perfect balance of gin and vermouth.',
    ingredients: [
    ...
    instructions: [
      ...
      { step: 2, description: 'Add gin and vermouth to a mixing glass with ice' },
  ...
  {
    name: 'Negroni',
    description: 'Perfect balance of gin, vermouth, and Campari - a bitter-sweet Italian classic.',
    ingredients: [
    ...
    instructions: [
      { step: 1, description: 'Add gin, vermouth, and Campari to a rocks glass with ice' },
  ...
  {
    name: 'Mojito',
    description: 'Refreshing Cuban cocktail with mint, lime, and rum - perfect for summer.',
    ingredients: [
    ...
    instructions: [
      { step: 1, description: 'Muddle mint leaves gently in the bottom of a highball glass' },
