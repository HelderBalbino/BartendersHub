...
const CloudinaryUploadTest = () => {
	...
	const { uploadImage, handleFileSelect, file, preview, uploading } =
		useImageUpload({
	...
	return (
		...
		>
					...
					{testResult.success ? (
						<div>
							...
							<p>
								...
								{testResult.result.publicId}
							</p>
							<p>
								<strong>Format:</strong>{' '}
								{testResult.result.format}
							</p>
							<p>
								<strong>Dimensions:</strong>{' '}
								{testResult.result.width}x
			...
			<div style={{ marginTop: '10px', fontSize: '10px', color: '#666' }}>
				<p>
					This test creates a tiny 1x1 pixel image and uploads it to
					Cloudinary to verify your configuration.
				</p>
			</div>
		</div>
	);
